...
function(e, t) {
    ...
    function N(e, t) {
        ...
        r.style && (o[a] = ue._data(r, "olddisplay"), n = r.style.display, t ? (o[a] || "none" !== n || (r.style.display = ""), "" === r.style.display && w(r) && (o[a] = ue._data(r, "olddisplay", S(r.nodeName)))) : o[a] || (i = w(r), (n && "none" !== n || !i) && ue._data(r, "olddisplay", i ? n: ue.css(r, "display"))));
        for (a = 0; s > a; a++) r = e[a],
    ...
    function S(e) {
        var t = Y,
        n = xt[e];
        return n || (n = A(e, t), "none" !== n && n || (lt = (lt || ue("<iframe frameborder='0' width='0' height='0'/>").css("cssText", "display:block !important")).appendTo(t.documentElement), t = (lt[0].contentWindow || lt[0].contentDocument).document, t.write("<!doctype html><html><body>"), t.close(), n = A(e, t), lt.detach()), xt[e] = n),
        n
    }
    function A(e, t) {
    ...
    function P(e, t, n) {
        ...
        c = l.props;
        for (R(c, l.opts.specialEasing); a > o; o++) if (r = nn[o].call(l, e, c, l.opts)) return r;
        return B(l, c),
    ...
    function W(e, t, n) {
        ...
        1 === e.nodeType && ("height" in t || "width" in t) && (n.overflow = [d.overflow, d.overflowX, d.overflowY], "inline" === ue.css(e, "display") && "none" === ue.css(e, "float") && (ue.support.inlineBlockNeedsLayout && "inline" !== S(e.nodeName) ? d.zoom = 1 : d.display = "inline-block")),
    ...
    Te = function(e) { (Y.addEventListener || "load" === e.type || "complete" === Y.readyState) && (we(), ue.ready())
    },
    we = function() {
    ...
    ue.extend({
        ...
        ready: function(e) {
            if (e === !0 ? !--ue.readyWait: !ue.isReady) {
                ...
                ue.isReady = !0,
                e !== !0 && --ue.readyWait > 0 || (X.resolveWith(Y, [ue]), ue.fn.trigger && ue(Y).trigger("ready").off("ready"))
            }
        },
    ...
    ue.ready.promise = function(t) {
        if (!X) if (X = ue.Deferred(), "complete" === Y.readyState) setTimeout(ue.ready);
        else if (Y.addEventListener) Y.addEventListener("DOMContentLoaded", Te, !1),
    ...
    ue.extend({
        ...
        removeAttr: function(e, t) {
            ...
            He.test(n) ? !Me && qe.test(n) ? e[ue.camelCase("default-" + n)] = e[r] = !1 : e[r] = !1 : ue.attr(e, n, ""),
    ...
    Se = {
        ...
        set: function(e, t, n) {
            return t === !1 ? ue.removeAttr(e, n) : _e && Me || !qe.test(n) ? e.setAttribute(!Me && ue.propFix[n] || n, n) : e[ue.camelCase("default-" + n)] = e[n] = !0,
            n
        }
    },
    ...
    ue.event = {
        ...
        fix: function(e) {
            ...
            o = e,
            a = this.fixHooks[i];
            for (a || (this.fixHooks[i] = a = Be.test(i) ? this.mouseHooks: Oe.test(i) ? this.keyHooks: {}), r = a.props ? this.props.concat(a.props) : this.props, e = new ue.Event(o), t = r.length; t--;) n = r[t],
            e[n] = o[n];
    ...
    function(e, t) {
        ...
        function f(e, t) {
            ...
            for (s = e, u = [], l = C.preFilter; s;) { (!n || (r = se.exec(s))) && (r && (s = s.slice(r[0].length) || s), u.push(i = [])),
                n = !1,
        ...
        function x(e, t, n, r) {
            ...
            if (!r && 1 === l.length) {
                ...
                for (i = pe.needsContext.test(e) ? 0 : o.length; i--&&(a = o[i], !C.relative[s = a.type]);) if ((u = C.find[s]) && (r = u(a.matches[0].replace(xe, Te), de.test(o[0].type) && t.parentNode || t))) {
                    if (o.splice(i, 1), e = r.length && p(o), !e) return Q.apply(n, K.call(r, 0)),
                    n;
                    break
                }
            }
            return S(e, l)(r, t, q, n, de.test(e)),
            n
        }
        function T() {}
        ...
        D = a.setDocument = function(e) {
            ...
            _ = [], M = [":focus"], (W.qsa = n(r.querySelectorAll)) && (o(function(e) {
                ...
                e.querySelectorAll("[selected]").length || M.push("\\[" + ee + "*(?:checked|disabled|ismap|multiple|readonly|selected|value)"),
                e.querySelectorAll(":checked").length || M.push(":checked")
            }), o(function(e) {
                e.innerHTML = "<input type='hidden' i=''/>",
                e.querySelectorAll("[i^='']").length && M.push("[*^$]=" + ee + "*(?:\"\"|'')"),
        ...
        a.attr = function(e, t) {
            ...
            return (e.ownerDocument || e) !== L && D(e),
            q || (t = t.toLowerCase()),
            (n = C.attrHandle[t]) ? n(e) : q || W.attributes ? e.getAttribute(t) : ((n = e.getAttributeNode(t)) || e.getAttribute(t)) && e[t] === !0 ? t: n && n.specified ? n.value: null
        },
        a.error = function(e) {
            ...
            pseudos: {
                ...
                lang: i(function(e) {
                    ...
                    function(t) {
                        var n;
                        do
                        if (n = q ? t.getAttribute("xml:lang") || t.getAttribute("lang") : t.lang) return n = n.toLowerCase(),
                        n === e || 0 === n.indexOf(e + "-");
    ...
    ue.fn.extend({
        ...
        html: function(e) {
            ...
            function(e) {
                ...
                if (! ("string" != typeof e || et.test(e) || !ue.support.htmlSerialize && Ye.test(e) || !ue.support.leadingWhitespace && Je.test(e) || at[(Qe.exec(e) || ["", ""])[1].toLowerCase()])) {
                    ...
                    try {
                        for (; i > r; r++) n = this[r] || {},
                        1 === n.nodeType && (ue.cleanData(b(n, !1)), n.innerHTML = e);
                        n = 0
                    } catch(e) {}
                }
        ...
        domManip: function(e, n, r) {
            ...
            if (f && (l = ue.buildFragment(e, this[0].ownerDocument, !1, this), i = l.firstChild, 1 === l.childNodes.length && (l = i), i)) {
                for (n = n && ue.nodeName(i, "tr"), s = ue.map(b(l, "script"), h), a = s.length; f > c; c++) o = l,
                c !== m && (o = ue.clone(o, !0, !0), a && ue.merge(s, b(o, "script"))),
                r.call(n && ue.nodeName(this[c], "table") ? d(this[c], "tbody") : this[c], o, c);
                if (a) for (u = s[s.length - 1].ownerDocument, ue.map(s, g), c = 0; a > c; c++) o = s[c],
    ...
    ue.extend({
        ...
        buildFragment: function(e, t, n, r) {
            ...
            d = p(t), h = [], g = 0; f > g; g++) if (o = e[g], o || 0 === o) if ("object" === ue.type(o)) ue.merge(h, o.nodeType ? [o] : o);
            else if (Ze.test(o)) {
    ...
    ue.fn.extend({
        ...
        toggle: function(e) {
            ...
            return this.each(function() { (t ? e: w(this)) ? ue(this).show() : ue(this).hide()
            })
        }
    }),
    ue.extend({
        ...
        css: function(e, n, r, i) {
            var o, a, s, u = ue.camelCase(n);
            return n = ue.cssProps[u] || (ue.cssProps[u] = T(e.style, u)),
    ...
    function(e, n) {
        ue.cssHooks[n] = {
            get: function(e, r, i) {
                return r ? 0 === e.offsetWidth && gt.test(ue.css(e, "display")) ? ue.swap(e, Tt,
                function() {
                    return E(e, n, i)
                }) : E(e, n, i) : t
            },
    ...
    ue.extend({
        ...
        ajax: function(e, n) {
            ...
            a = p.url,
            p.hasContent || (p.data && (a = p.url += (qt.test(a) ? "&": "?") + p.data, delete p.data), p.cache === !1 && (p.url = _t.test(a) ? a.replace(_t, "$1_=" + Ht++) : a + (qt.test(a) ? "&": "?") + "_=" + Ht++)),
            p.ifModified && (ue.lastModified[a] && w.setRequestHeader("If-Modified-Since", ue.lastModified[a]), ue.etag[a] && w.setRequestHeader("If-None-Match", ue.etag[a])),
            ...
            return {
                send: function(i, o) {
                    ...
                    r = function(e, i) {
                        var s, l, c, f;
                        try {
                            if (r && (i || 4 === u.readyState)) if (r = t, a && (u.onreadystatechange = ue.noop, Gt && delete Vt[a]), i) 4 !== u.readyState && u.abort();
                            else {
                                f = {},
                                s = u.status,
                    ...
                    ue(e).unload(Gt)), Vt[a] = r), u.onreadystatechange = r) : r()
                },
                abort: function() {
                    r && r(t, !0)
                }
    ...
    ue.fx.tick = function() {
        var e, n = ue.timers,
        r = 0;
        for (Qt = ue.now(); n.length > r; r++) e = n[r],
